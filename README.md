...
docker exec indexd python /indexd/cli/index_admin.py create --username $username --password $password
docker exec indexd python /indexd/cli/index_admin.py delete --username $username
```
